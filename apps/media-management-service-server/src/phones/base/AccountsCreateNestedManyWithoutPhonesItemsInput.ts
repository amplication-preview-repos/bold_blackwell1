...
@InputType()
class AccountsCreateNestedManyWithoutPhonesItemsInput {
...
export { AccountsCreateNestedManyWithoutPhonesItemsInput as AccountsCreateNestedManyWithoutPhonesItemsInput };
