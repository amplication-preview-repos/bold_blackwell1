...
@InputType()
class ClientsBooksCreateNestedManyWithoutClientsItemsInput {
...
export { ClientsBooksCreateNestedManyWithoutClientsItemsInput as ClientsBooksCreateNestedManyWithoutClientsItemsInput };
