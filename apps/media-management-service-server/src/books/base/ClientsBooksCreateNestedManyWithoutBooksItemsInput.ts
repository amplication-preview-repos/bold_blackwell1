...
@InputType()
class ClientsBooksCreateNestedManyWithoutBooksItemsInput {
...
export { ClientsBooksCreateNestedManyWithoutBooksItemsInput as ClientsBooksCreateNestedManyWithoutBooksItemsInput };
