...
class SoundsCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => SoundsLabelsCreateNestedManyWithoutSoundsItemsInput,
  })
  @ValidateNested()
  @Type(() => SoundsLabelsCreateNestedManyWithoutSoundsItemsInput)
  @IsOptional()
  @Field(() => SoundsLabelsCreateNestedManyWithoutSoundsItemsInput, {
    nullable: true,
  })
  soundsLabelsItems?: SoundsLabelsCreateNestedManyWithoutSoundsItemsInput;
}

export { SoundsCreateInput as SoundsCreateInput };
